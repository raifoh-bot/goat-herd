...
export const ListGoatsResponseItem = zod.object({
  ...
  lactationStatus: zod.enum(["milking", "dry", "kid", "retired"]).nullish(),
  breedingStatus: zod.enum(["exposed", "serviced", "pregnant"]).nullish(),
  ...
  goats: zod.array(
    zod.object({
      ...
      eidNumber: zod
        ...
        .optional(),
      lactationStatus: zod
        .enum(["milking", "dry", "kid", "retired"])
        .optional(),
      breedingStatus: zod.enum(["exposed", "serviced", "pregnant"]).optional(),
    }),
  ),
});
      ...
      doe: zod
        .object({
          ...
          lactationStatus: zod
            ...
            .nullish(),
          breedingStatus: zod
            .enum(["exposed", "serviced", "pregnant"])
            .nullish(),
          age: zod
            .number()
            .describe("Calculated age in years from dateOfBirth"),
