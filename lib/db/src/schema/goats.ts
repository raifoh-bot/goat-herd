...
export const goatsTable = pgTable("goats", {
  ...
  lactationStatus: text("lactation_status", { enum: ["milking", "dry", "kid", "retired"] }),
  breedingStatus: text("breeding_status", { enum: ["exposed", "serviced", "pregnant"] }),
  age: integer("age"),
  description: text("description"),
  imageUrl: text("image_url"),
  imageUrls: text("image_urls").array().notNull().default([]),
  defaultPhotoIndex: integer("default_photo_index"),
  herdStatus: text("herd_status", { enum: ["dead", "leased", "on-farm", "retired", "sold-registered", "sold-not-registered"] }).default("on-farm"),
