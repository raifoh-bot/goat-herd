...
import { useSuperadminForgotPassword } from "@workspace/api-client-react";
...
export default function SuperadminForgotPassword() {
  ...
  const forgotPassword = useSuperadminForgotPassword();
        ...
        <CardHeader className="text-center pt-10">
          ...
          <CardDescription>
            {submitted
              ...
              : "Enter your platform admin username or email and we'll send you a reset link."}
          </CardDescription>
        </CardHeader>
          ...
          {submitted ? (
            <div className="space-y-4">
              <p className="text-sm text-muted-foreground text-center">
                If an account matches, we've sent a password reset link to its
